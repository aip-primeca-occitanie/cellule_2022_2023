...
def ControlCallback(pub_yaska1):
	...
	if pub_yaska1.data == 1:
		...
		armgroup = moveit_commander.MoveGroupCommander("DN2P", robot_description="/yaska1/robot_description", ns="/yaska1")
	elif pub_yaska1.data == 3:
		armgroup = moveit_commander.MoveGroupCommander("DPN1", robot_description="/yaska1/robot_description", ns="/yaska1")
	elif pub_yaska1.data == 4:
		armgroup = moveit_commander.MoveGroupCommander("DPN2", robot_description="/yaska1/robot_description", ns="/yaska1")
	else :
		print("Error callback control yaska1 \n")
		return
