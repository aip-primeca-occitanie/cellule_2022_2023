...
{	
	...
	robot_publisher_state = noeud.advertise<robot_arm::State>("/"+robot+"_state", 1);
	
	ros::Publisher robot_publisher_cart;
	robot_publisher_cart = noeud.advertise<robot_arm::Cart>("/"+robot+"_cart", 1);
