...
#include <robot_arm/Calib_camera.h>
#include <robot_arm/Objet_camera.h>
#include <chrono>
#include <thread> 
using namespace std;
...
//Pour le topic /state
void Cognex::calibCallback(const robot_arm::Calib_camera::ConstPtr& msg) 
{
	_point0 = msg->point0;
	_point1 = msg->point1;
	_point2 = msg->point2;
...
void Cognex::objetCallback(const robot_arm::Objet_camera::ConstPtr& msg) 
{
	_go = msg->go;
    _x = msg->x;
	_y = msg->y;
