...
from robot_arm.msg import Joint
#fichier serveur 1 , 2 ou 3 selon le robot 
global name
...
HOST=''
if name == 'staubli' : # Permet de se connecter à un robot définit dans le programme cpp pick and place
	PORT=50001
elif name == 'kuka' :
	PORT=50002
else :
